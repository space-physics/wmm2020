...
static PyObject *
wmm_ext_wmmsub(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    ret = wmmsub(geolatitude, geolongitude, HeightAboveEllipsoid, yeardecimal,
...
static PyMethodDef wmm_ext_module_methods[] = {
    {"wmmsub", (PyCFunction)wmm_ext_wmmsub, METH_VARARGS | METH_KEYWORDS,
...
// Note: "wmm_ext" is the compiled name. It will compile to "wmm_ext.pyd"
...
static struct PyModuleDef c2module = {
    ...
    -1,
    wmm_ext_module_methods, NULL, NULL, NULL, NULL
};
...
init_wmm_ext(void)
{
    ...
    m = Py_InitModule("wmm_ext", c2module);
    if (m == NULL) return;
}
